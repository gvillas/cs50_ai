...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.knowledge.append(Sentence(cells=sentence_cells, count=count))
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                if sentence1.cells == sentence2.cells:
                    ...
                    sentences_to_add.append(Sentence(cell, sentence2
                    if sentence2 not in sentences_to_remove:
                        sentences_to_remove.append(sentence2)

                    sentence_count = sentence2.count - sentence1.count
                    sentences_to_add.append(Sentence(cells=sentence_cells, count=sentence_count))  # conferir variaveis
